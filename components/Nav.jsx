...
function Nav() {
  ...
  return (
    <div className="min-w-screen h-80">
      <div className="w-full md:flex md:gap-20 lg:px-44 md:px-10 px-4 md:pt-10 pt-5 relative">
        {/* Profile Picture */}
        <div className="">
          ...
          <div className="w-full flex justify-between md:mt-6">
            ...
            <div className="flex gap-3 items-center">
              ...
              {/* <div onMouseEnter={BtnClick} onMouseLeave={textLeave} className="md:w-10 md:h-10 w-8 h-8 flex justify-center items-center rounded-full border-2 hover:bg-green-800 hover:text-white transition-all duration-300">
                <Link href="https://www.instagram.com/rahhul_36/">
            ...
            {isVisible.testimonials ? (
              /* Add testimonials */
              <div onMouseEnter={BtnClick} onMouseLeave={textLeave} className="md:w-52 md:h-8 border border-green-800 rounded-full flex justify-center items-center md:text-sm md:tracking-wider md:px-4 text-xs px-2 gap-2 text-green-800 hover:bg-green-800 hover:text-white transition-all duration-300">
                  Add Testimonials
                  <Plus width="14" />
                </div>
              // <Dialog className="">
